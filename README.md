# Entorno de trabajo básico con React

Este entorno es una copia del entorno generado por [Create React App](https://github.com/facebookincubator/create-react-app).

El código generado es exactamente el mismo, la única diferencia es que en este repositorio se han eliminado todos los archivos que estaban por defecto en la carpeta `src`, excepto `index.js`. Además, a partir de ese único archivo se ha desarrollado el resto.

Y se han modificado estos otros:

Esto se ha hecho porque por el momento y para los proyectos que vamos a crear, no vamos a darles uso.

Si quieres generar un proyecto con al estructura que tendría si hubiesemos utilizado [Create React App](https://github.com/facebookincubator/create-react-app), puedes visitar el enlace para obtener más información.

A continuación se muestra la información por defecto que genera Create React App. Esta información se mantiene aquí porque puede ser de utilidad como recurso de consulta.

Como se explica anteriormente, este repositorio sirve sólo como ejemplo para ilustrar cómo trabajar paso a paso con React y React Create App pero se recomienda que no se utilice como base y que en su caso, se utilice [Create React App](https://github.com/facebookincubator/create-react-app) para crear un proyecto de cero con React.

---

## Texto creado por Create React App
